...
**[Leaderboard]** is a project that uses a Single Page Application format and API to add and update the scores of different players of a game
...
- **[Modules will be used for imported/exported for the JavaScript files]**
- **[Webpack bundling was used]**
- **[Leaderboard API will be consumed]**
...
git clone https://github.com/yayaismaail/leaderboard
